...
- **代码示例可切换为 Python。** 原书示例以 Java 为主，另有少量 C++ 和 Go。阅读设置里选择“Python”后，63 个示例中的 58 个会替换成等价的 Python 改写并带语法高亮，其余 5 个保留原文并注明原因。
...
| 正文 | 小节图解内嵌显示，脚注和译者注点击弹出，代码示例按设置显示原文或 Python 改写 |
| 章末 | 上一章 / 下一章 |
